    ...
    <div>
      <nav style={{ padding: '1.5rem 0', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Link to="/app" className="btn btn-primary" style={{ padding: '0.5rem 1rem' }}>Open Studio</Link>
        </div>
      </nav>
      ...
      <section style={{ padding: 'var(--section-spacing) 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '1.25rem', color: 'var(--text-muted)', maxWidth: '600px', margin: '0 auto 2.5rem' }}>
            VibeKit Studio lets you pick a design vibe, customize your page with a live editor, and publish it instantly. No login required.
          </p>
          <Link to="/app" className="btn btn-primary" style={{ fontSize: '1.125rem', padding: '1rem 2rem' }}>
      ...
      <section style={{ padding: 'var(--section-spacing) 0', textAlign: 'center', background: 'var(--accent)', color: 'var(--bg)' }}>
        <div className="container">
          ...
          <p style={{ opacity: 0.8, marginBottom: '2rem' }}>Start building your mini-site in minutes. No signup needed.</p>
          <Link to="/app" className="btn" style={{ background: 'var(--bg)', color: 'var(--accent)', fontSize: '1.125rem', padding: '1rem 2rem' }}>
            Open Studio
          </Link>
        </div>
      </section>
